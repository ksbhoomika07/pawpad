...
const GROOM_PACKAGES = [
  ...
  },
  {
    ...
    notIncluded: [
      "No nail trim, ear cleaning, or anal gland expression",
      "No hygiene clip, scissoring, or clipping",
      "Matted coats or dogs needing extra care are redirected to full grooming at intake"
    ],
  ...
  },
  {
    ...
    notIncluded: [
      "No nail trim, ear cleaning, or anal gland expression",
      "No hygiene clip, scissoring, or clipping",
      "Matted coats or cats needing extra care are redirected to full grooming at intake"
    ],
  ...
  },
  {
    ...
    notIncluded: [
      "Non-transferable",
      "Same matting/extra-care eligibility rules apply per visit",
      "Unused sessions expire at end of window — no rollover or refund"
    ],
  ...
  return (
    <section className="g-packages" id="packages">
              ...
              <article key={p.key} className={"g-pkg-card " + (isOpen ? "open" : "")} style={{transitionDelay: `${i*60}ms`}}>
                ...
                <div className="g-pkg-body">
                  ...
                  <div className="g-pkg-details">
                    <div className="g-pkg-detail-group">
                      <h5>Included</h5>
                      <ul>
                        {p.includes.map(inc => (
                    ...
                    {p.notIncluded && (
                      <div className="g-pkg-detail-group g-pkg-not-included">
                        <h5>Not Included</h5>
                        <ul>
                          {p.notIncluded.map(item => (
                            <li key={item}><PawIcon size={10} color="var(--driftwood)" /> {item}</li>
                          ))}
                        </ul>
                      </div>
                    )}
      ...
      <style>{`
        ...
        .g-pkg-detail-group + .g-pkg-detail-group { margin-top: 18px; }
        .g-pkg-details h5 {
