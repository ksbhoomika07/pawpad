/* experience.jsx — The Pawpad Experience page */
  ...
  return (
    <section className="exp-hero">
      <div className="container">
        <p className="eyebrow reveal in">The Pawpad experience</p>
        <h1 className="h-display reveal in" style={{marginTop:24, maxWidth:"18ch"}}>
          What it actually <em className="italic" style={{color:"var(--driftwood)"}}>feels like</em> to bring your pet here
        </h1>
        <p className="lead reveal in" style={{marginTop:28, maxWidth:"60ch"}}>
          At Pawpad, appointments are intentionally spaced out to ensure that grooming is never rushed. We work at a pace that allows pets to settle, adjust, and feel comfortable throughout the grooming process.
        </p>
      </div>
      <style>{`
    ...
    <section className="handling">
      <div className="container">
        <div className="handling-grid">
          <div className="handling-images reveal">
            <div className="h-img-1 blob-2"><img src="assets/img/pawpad/grooming-snapshot-new.jpg" alt="Gentle grooming at Pawpad" /></div>
            <div className="h-img-2 blob-1"><img src="assets/img/pawpad/grooming-page-grooming-massage.webp" alt="A dog calmly relaxing during a gentle massage" /></div>
          <div className="handling-badge">
              <PawIcon size={20} color="var(--driftwood)" />
              <div>
                <strong>Calm</strong>
                <span>appointment-only care with room to pause</span>
              </div>
            </div>
          </div>
          <div className="handling-text reveal">
            <p className="eyebrow">The Pawpad experience</p>
            <h2 className="h-1" style={{marginTop:18, maxWidth:"15ch"}}>
              Grooming at <em className="italic" style={{color:"var(--driftwood)"}}>your pet's pace</em>
            </h2>
            <p style={{marginTop:28, maxWidth:"54ch"}}>Every session is guided by the individual animal. We pay close attention to body language, comfort levels, and stress signals, adapting our approach as needed. If a pet requires more time, more breaks, or a slower introduction to a particular part of grooming, that is exactly what they receive.</p>
            <p style={{maxWidth:"54ch"}}>The grooming environment has been designed to minimise unnecessary stress and overstimulation. Appointments are staggered to avoid crowded spaces, excessive noise, and overwhelming activity.</p>
            <p style={{maxWidth:"54ch"}}>Every pet receives dedicated attention throughout their appointment. We take the time to understand their individual needs, preferences, sensitivities, and comfort levels before and during the grooming process.</p>
            <p style={{maxWidth:"54ch"}}>Our approach to animal handling has been shaped by years of working with rescue animals, community animals, and pets with a wide range of personalities and experiences. Trust cannot be forced. It is built through patience, consistency, and respect for what an animal is communicating.</p>
            <p style={{maxWidth:"54ch"}}>For anxious or reactive pets, we assess each pet individually and adapt our handling and grooming approach to suit their comfort levels. We also offer guidance to help owners maintain coat care and hygiene in ways that are appropriate for their individual pet.</p>
          </div>
        </div>
      </div>
      <style>{`
    ...
    <section className="products">
      <div className="container">
        <div className="products-head reveal">
          <p className="eyebrow">Products we use</p>
          <h2 className="h-1" style={{marginTop:18, maxWidth:"22ch"}}>
            What we put <em className="italic" style={{color:"var(--driftwood)"}}>on them</em>, matters
          </h2>
          <p className="lead" style={{marginTop:24, maxWidth:"54ch"}}>
            We use professional-grade grooming products selected according to each pet's individual coat type, skin condition, sensitivities, and grooming requirements.
          </p>
        </div>
        <div className="products-grid reveal">
          {products.map((p, i) => (
            <div key={p.name} className="product-card" style={{transitionDelay:`${i*70}ms`}}>
              <div className="product-no">0{i+1}</div>
              <h4 className="h-3" style={{fontFamily:"var(--f-display)"}}>{p.name}</h4>
              <p>{p.note}</p>
            </div>
          ))}
        </div>
